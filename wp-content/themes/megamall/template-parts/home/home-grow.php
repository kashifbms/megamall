    ...
    <div class="container">
        ...
        <div class="mm-home-shop-header">
            <div class="mm-home-shop-text">
                <span class="mm-section-label">QUICK LINKS</span>
                <h2 class="mm-section-title">Grow with Us</h2>

                <p class="mm-section-description">
                    Promote, lease, advertise or partner with us. Explore the possibilities below.
                </p>
